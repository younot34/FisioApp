    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Edit Data Karyawan</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('adm.karyawan.update')}}" method="post">
                            @csrf
                            @method('PATCH')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <input type="hidden" name="user_id" value="{{old('karyawan_id',encrypt($dataKaryawan->id) ?? "")}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                    ...
                                                    <input name="nip" type="text"
                                                           ...
                                                           id="nip" value="{{old('nip',$dataKaryawan->karyawan->nip ?? "")}}"
                                            ...
                                            <div class="col-lg-6">
                                                    ...
                                                    <input name="email" type="email"
                                                           ...
                                                           id="email" value="{{old('email',$dataKaryawan->email ?? "")}}"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-12">
                                                    ...
                                                    <input name="name" type="text"
                                                           ...
                                                           id="name" value="{{old('name',$dataKaryawan->name ?? "")}}"
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <select name="role_id" class="form-control select" id="role">
                                                    @foreach($dataRole as $role)
                                                        <option value="{{base64_encode($role->id)}}" @if(base64_encode($role->id) == old('role_id',base64_encode($dataKaryawan->role_id ?? "")))selected @endif>{{$role->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div>
                                                    ...
                                                    <input name="phone" type="text"
                                                           ...
                                                           id="phone" value="{{old('phone',$dataKaryawan->karyawan->phone ?? "")}}"
                                                           placeholder="Phone" >
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                    ...
                                                    <select name="sex" id="sex" class="form-control select">
                                                        <option value="L" @if("L" == old('sex',$dataKaryawan->karyawan->sex ?? "")) selected @endif>Pria</option>
                                                        <option value="P" @if("P" == old('sex',$dataKaryawan->karyawan->sex ?? "")) selected @endif>Wanita</option>
                                                    </select>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="alamat" class="form-control @if($errors->has('alamat')) is-invalid @endif" id="alamat" cols="30" rows="10">{{old('alamat',$dataKaryawan->karyawan->alamat ?? "")}}</textarea>
                                            </div>
                                        </div>
                                    </div>
