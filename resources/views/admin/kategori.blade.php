<x-admint.admin-template :title="$title" :first-menu="$firstMenu" :second-menu="$secondMenu">
    ...
    <div class="modal fade" id="modalAdd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                <form action="{{route('adm.kategori.save')}}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <label
                                    for="name" class="form-label">NAMA KATEGORI</label>
    ...
    <div class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                <form action="{{route('adm.kategori.update')}}" method="post">
                    @csrf
                    @method('PATCH')
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <label
                                    for="nameEdit" class="form-label">NAMA KATEGORI</label>
