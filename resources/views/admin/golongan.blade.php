<x-admint.admin-template :title="$title" :first-menu="$firstMenu" :second-menu="$secondMenu">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Golongan Obat</h4>
    ...
    <div class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                <form action="{{route('adm.golongan.update')}}" method="post">
                    @csrf
                    @method('PATCH')
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="hidden" name="golongan_id" id="golongan_id">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <label
                                    for="nameEdit" class="form-label">NAMA GOLONGAN</label>
                                <input type="text" name="name" id="nameEdit" class="form-control inputForm"
                                       value="{{old('name')}}" maxlength="255"/>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalHapus" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                <form action="{{route('adm.golongan.delete')}}" method="post">
                    @csrf
                    @method('DELETE')
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="hidden" name="golongan_id" id="golongan_id_delete">
                            </div>
                        </div>
                        <div class="row mt-3">
    ...
    @push('customJs')
        ...
        <script>
            ...
            $(document).ready(function () {
                let base_url = "{{route('adm.golongan')}}";
