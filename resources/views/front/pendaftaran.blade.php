                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <label for="nik" class="form-label">NIK <span
                                            ...
                                            class="form-control @if($errors->has('nik'))  @endif"
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="nama_lengkap"
                                               class="form-control @if($errors->has('nama_lengkap'))  @endif"
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="tempat_lahir"
                                               class="form-control @if($errors->has('tempat_lahir'))  @endif"
                                    ...
                                    <div class="col-lg-4">
                                        <label for="tanggal_lahir" class="form-label">TANGGAL LAHIR <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="tanggal_lahir" class="form-control @if($errors->has('tanggal_lahir'))  @endif"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" name="tekanan_darah" id="tekanan_darah"
                                               class="form-control @if($errors->has('tekanan_darah'))  @endif" placeholder="mmHg" value="{{old('tekanan_darah')}}" maxlength="3">
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-12">
                                        <label for="dokter_id" class="form-label">POLIKLINIK</label>
                                        <select name="dokter_id" id="dokter_id" class="form-control select @if($errors->has('dokter_id'))  @endif">
                                ...
                                <div class="row mt-2">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" id="suhu_badan" name="suhu_badan" class="form-control @if($errors->has('suhu_badan'))  @endif" placeholder="*C" value="{{old('suhu_badan')}}" maxlength="3">
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-12">
                                        <label for="berat_badan" class="form-label">BERAT BADAN </label>
                                        <input type="text" id="berat_badan" name="berat_badan" class="form-control @if($errors->has('berat_badan'))  @endif" placeholder="kg" value="{{old('berat_badan')}}" maxlength="3">
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-12">
                                        <label for="tinggi_badan" class="form-label">TINGGI BADAN </label>
                                        <input type="text" id="tinggi_badan" name="tinggi_badan" class="form-control @if($errors->has('tinggi_badan'))  @endif" placeholder="cm" value="{{old('tinggi_badan')}}" maxlength="3">
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-12">
                                        <label for="keluhan_utama" class="form-label">KELUHAN <span
                                                class="text-danger">*</span></label>
                                        <textarea name="keluhan_utama" class="form-control @if($errors->has('keluhan_utama'))  @endif" id="keluhan_utama" cols="30" rows="3">{{old('keluhan_utama')}}</textarea>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-12">
